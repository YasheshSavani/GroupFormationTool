...
public class QuestionsQuery {
	...
	public static final String GET_SORTED_TITLE_DATE = "Select distinct dateCreated, questionTitle from questions_manager where instructorUserName=? group by questionTitle order by dateCreated";
	public static final String GET_ALL_QUESTIONS = "SELECT * from questions_manager where instructorUserName=?";
	public static final String SEARCH_OCCURENCE = "SELECT * FROM question_options where questionId = ?";
	public static final String DELETE_QUESTION_OPTIONS = "DELETE from question_options where questionId = ?";
